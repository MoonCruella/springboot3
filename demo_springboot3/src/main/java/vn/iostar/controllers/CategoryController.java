...
public class CategoryController  {
	...
	@RequestMapping("")   // "" co nghia la chi can truy cap toi /admin/categories la lay duoc list 
	public String all(Model model) {
		List<Category> list = categoryService.findAll();
		model.addAttribute("list",list); // tuong duong voi lenh request.setAttribute
	...
	public ModelAndView saveOrUpdate(ModelMap model,
		...
		//BeanUtils : copy tu Model sang Entity
	...
	public ModelAndView edit(ModelMap model,@PathVariable("id") Long categoryId) {
		...
		model.addAttribute("message","Cateogory is not existed!!!");
		return new ModelAndView("forward:/admin/categories",model);
